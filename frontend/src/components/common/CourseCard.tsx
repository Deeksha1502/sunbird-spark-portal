            ...
            >
                ...
                <div className="px-[1.25rem] pt-[1.25rem] w-full">
                    <div className="relative overflow-hidden rounded-[1.25rem] h-[10.125rem] w-full">
                        <img
                            src={course.image || course.thumbnail} // Handle both image and thumbnail
                            alt={course.title}
                ...
                <div className="px-[1.25rem] pt-[1.25rem] pb-5 flex flex-col flex-grow">
                    ...
                    >
                        {t(`contentTypes.${(course.type || course.category || 'Course').toLowerCase()}`, { defaultValue: course.type || 'Course' })}
                    </Badge>

                    {/* Title */}
                    <h3
                        className="font-rubik font-[450] text-[1rem] leading-[1.75rem] tracking-normal bg-transparent border-0 text-foreground mb-[1.25rem] min-h-[3.5rem]"
                    >
                        {course.title}
                    </h3>
                    ...
                    >
                        ...
                        <span>{course.learners || course.enrolledCount || "0"} {t("contentStats.learners")}</span>
                        <span className="mx-0.5">•</span>
