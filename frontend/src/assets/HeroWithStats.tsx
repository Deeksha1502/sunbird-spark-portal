...
const HeroWithStats = ({ currentLang }: HeroWithStatsProps) => {
  const avatars = [
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid lg:grid-cols-2 gap-8 items-center min-h-[420px] py-12 lg:py-16">
            ...
            <div className="text-left max-w-xl">
              ...
              >
                Unlock your potential and explore a world of knowledge. Start your
                journey with 100+ courses built for your future.
              </p>
          ...
          <div className="flex w-full flex-wrap items-end gap-4 lg:gap-5 lg:flex-nowrap lg:justify-between">
            ...
            >
              <div>
                ...
                >
                  The learning process<br />is simple
                </p>
              </div>
              <div>
                <span 
